      ...
      {process.env.NEXT_PUBLIC_ENABLE_SIMULATION === "true" && (
        <div className="bg-blue-50 border border-blue-200 rounded-md p-4 flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            <strong>Manual reading entry.</strong> Use the &quot;Simulate
            reading&quot; option from the menu on each device to log a reading
            by hand — useful while a plot&apos;s sensor hardware is being
